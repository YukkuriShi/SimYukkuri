...
public class TrashUtil {
	...
	public enum OkazariType {
		DEFAULT("", 0, 0, 0, 0, 0, 0),
		ALICE("Aliceokazari", 0, 0, 0, 0, 0, 0),
		AYAYA("Ayayaokazari", 0, 0, 0, 0, 0, 0),
		CHEN("Chenokazari", 0, 0, 0, 0, 0, 0),
		CHIRUNO("Chirunookazari", 0, 0, 0, 0, 0, 0),
		DEIBU("Deibuokazari", 0, 0, 0, 0, 0, 0),
		DOSMARISA("DosMarisaokazari", 0, 0, 0, 0, 0, 0),
		EIKI("Eikiokazari", 0, 0, 0, 0, 0, 0),
		FRAN("Franokazari", 0, 0, 0, 0, 0, 0),
		KIMEEMARU("Kimeemaruokazari", 0, 0, 0, 0, 0, 0),
		MARISAKOTATSUMURI("MarisaKotatsumuriokazari", 0, 0, 0, 0, 0, 0),
		MARISA("Marisaokazari", 0, 0, 0, 0, 0, 0),
		MARISAREIMU("MarisaReimuokazari", 0, 0, 0, 0, 0, 0),
		MARISATSUMURI("MarisaTsumuriokazari", 0, 0, 0, 0, 0, 0),
		MEIRIN("Merinokazari", 0, 0, 0, 0, 0, 0),
		MYON("Myonokazari", 0, 0, 0, 0, 0, 0),
		NITORI("Nitoriokazari", 0, 0, 0, 0, 0, 0),
		PATCH("Patchokazari", 0, 0, 0, 0, 0, 0),
		RAN("Ranokazari", 0, 0, 0, 0, 0, 0),
		REIMUMARISA("ReimuMarisaokazari", 0, 0, 0, 0, 0, 0),
		REIMU("Reimuokazari", 0, 0, 0, 0, 0, 0),
		REMIRYA("Remiryaokazari", 0, 0, 0, 0, 0, 0),
		SAKUYA("Sakuyaokazari", 0, 0, 0, 0, 0, 0),
		SUWAKO("Suwakookazari", 0, 0, 0, 0, 0, 0),
		TENKO("Tenkookazari", 0, 0, 0, 0, 0, 0),
		UDONGE("Udongeokazari", 0, 0, 0, 0, 0, 0),
		WASAREIMU("WasaReimuokazari", 0, 0, 0, 0, 0, 0),
		YURUSANAE("Yurusanaeokazari", 0, 0, 0, 0, 0, 0),
		YUUKA("Yuukaokazari", 0, 0, 0, 0, 0, 0),
		YUYUKO("Yuyukookazari", 0, 0, 0, 0, 0, 0),
