...
public class Yuyuko extends Body implements java.io.Serializable {
	...
	public Yuyuko(int initX, int initY, int initZ, Body.AgeState initAgeState, Body p1, Body p2) {
		super(initX, initY, initZ, initAgeState, p1, p2);
		setBoundary(boundary, braidBoundary);
		msgType = YukkuriType.YUYUKO;
	...
	public void tuneParameters() {
		...
		VALUESALE[AgeState.ADULT.ordinal()] = 5*valueSale - 100;
		VALUESALE[AgeState.CHILD.ordinal()] = 2*valueSale;
		VALUESALE[AgeState.BABY.ordinal()] = valueSale / 2 ;
