...
public class Yurusanae extends Body implements java.io.Serializable {
	...
	public static final String nameJ = "Yurusanae";
	public static final String nameE = "Sanae";
	...
	public static void loadImages (ClassLoader loader, ImageObserver io) throws IOException {
		...
		ModLoader.loadBodyImagePack(loader, images, "yurusanae", io);
	...
	// public methods
	public Yurusanae(int initX, int initY, int initZ, Body.AgeState initAgeState, Body p1, Body p2) {
		super(initX, initY, initZ, initAgeState, p1, p2);
		setBoundary(boundary, braidBoundary);
		msgType = YukkuriType.YURUSANAE;
		shitType = YukkuriType.YURUSANAE;
	}
