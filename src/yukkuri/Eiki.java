...
public class Eiki extends Body implements java.io.Serializable {
	...
	public static final String nameJ = "Eiki";
	public static final String nameE = "Eiki";
	
	public static final int valueSale = 600;
	...
	public static void loadImages (ClassLoader loader, ImageObserver io) throws IOException {
		...
		ModLoader.loadBodyImagePack(loader, images, "eiki", io);
	...
	// public methods
	public Eiki(int initX, int initY, int initZ, Body.AgeState initAgeState, Body p1, Body p2) {
		super(initX, initY, initZ, initAgeState, p1, p2);
		setBoundary(boundary, braidBoundary);
		msgType = YukkuriType.EIKI;
		shitType = YukkuriType.EIKI;
	}
	...
	public void tuneParameters() {
		...
		int stressFactor = rnd.nextInt(400) - 200;
