...
public class Myon extends Body implements java.io.Serializable {
	...
	public static final String nameJ = "縺ｿ繧�ｓ";
	public static final String nameE = "Myon";
	
	public static final int valueSale = 225;
	public static final int valuePurchase = 450;
	...
	public static void loadImages (ClassLoader loader, ImageObserver io) throws IOException {
		...
		ModLoader.loadBodyImagePack(loader, images, "myon", io);
	...
	public Myon(int initX, int initY, int initZ, Body.AgeState initAgeState, Body p1, Body p2) {
		super(initX, initY, initZ, initAgeState, p1, p2);
		setBoundary(boundary, braidBoundary);
		msgType = YukkuriType.MYON;
		shitType = YukkuriType.MYON;
	}
