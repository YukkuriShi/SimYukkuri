...
public class Nitori extends Body implements java.io.Serializable {
	...
	public static final String nameJ = "Nitori";
	public static final String nameE = "Nitori";
	
	public static final int valueSale = 550;
	...
	public static void loadImages (ClassLoader loader, ImageObserver io) throws IOException {
		...
		ModLoader.loadBodyImagePack(loader, images, "nitori", io);
	...
	// public methods
	public Nitori(int initX, int initY, int initZ, Body.AgeState initAgeState, Body p1, Body p2) {
		super(initX, initY, initZ, initAgeState, p1, p2);
		setBoundary(boundary, braidBoundary);
		msgType = YukkuriType.NITORI;
		shitType = YukkuriType.NITORI;
	}
