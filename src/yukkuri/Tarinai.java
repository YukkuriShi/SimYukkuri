...
public class Tarinai extends Body implements java.io.Serializable {
	...
	public static final String nameJ = "縺溘ｊ縺ｪ縺�ｆ";
	public static final String nameE = "Tarinai";
	...
	public static void loadImages (ClassLoader loader, ImageObserver io) throws IOException {
		...
		ModLoader.loadBodyImagePack(loader, images, "tarinai", io);
	...
	public Tarinai(int initX, int initY, int initZ, Body.AgeState initAgeState, Body p1, Body p2) {
		...
		msgType = YukkuriType.TARINAI;
		shitType = YukkuriType.TARINAI;
	}
	...
	public void tuneParameters() {
		...
		int StressMedian = 300;
		STRESSLIMIT[AgeState.ADULT.ordinal()] =StressMedian + stressFactor;
		STRESSLIMIT[AgeState.CHILD.ordinal()] =StressMedian + stressFactor - 100;
		STRESSLIMIT[AgeState.BABY.ordinal()] = StressMedian + stressFactor - 200;
