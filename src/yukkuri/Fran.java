...
public class Fran extends Body implements java.io.Serializable {
	...
	public static void loadImages (ClassLoader loader, ImageObserver io) throws IOException {
		...
		ModLoader.loadBodyImagePack(loader, images, "fran", io);
	...
	// public methods
	public Fran(int initX, int initY, int initZ, Body.AgeState initAgeState, Body p1, Body p2) {
		super(initX, initY, initZ, initAgeState, p1, p2);
		setBoundary(boundary, braidBoundary);
		msgType = YukkuriType.FRAN;
		shitType = YukkuriType.FRAN;
	}
