...
public class Meirin extends Body implements java.io.Serializable {
	static final long serialVersionUID = 1L;
	public static final int type = 1005;
	public static final String nameJ = "繧√�繧翫ｓ";
	public static final String nameE = "Meiling";
	
	public static final int valueSale = 500;
	public static final int valuePurchase = 1000;
	...
	public static void loadImages (ClassLoader loader, ImageObserver io) throws IOException {
		...
		ModLoader.loadBodyImagePack(loader, images, "merin", io);
	...
	// public methods
	public Meirin(int initX, int initY, int initZ, Body.AgeState initAgeState, Body p1, Body p2) {
		super(initX, initY, initZ, initAgeState, p1, p2);
		setBoundary(boundary, braidBoundary);
		msgType = YukkuriType.MEIRIN;
		shitType = YukkuriType.MEIRIN;
	}
