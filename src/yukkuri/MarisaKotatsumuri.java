...
public class MarisaKotatsumuri extends Body implements java.io.Serializable {
	...
	public static final String nameE = "Kotatsu Marisa";
	...
	public static void loadImages (ClassLoader loader, ImageObserver io) throws IOException {
		...
		ModLoader.loadBodyImagePack(loader, images, "marisa_kotatumuri", io);
	...
	public void tuneParameters() {
		...
		STRESSLIMIT[AgeState.BABY.ordinal()] = StressMedian + stressFactor - 250;
		 ...
		 okazariType = OkazariType.MARISAKOTATSUMURI;
		...
		TRASH_OKAZARI_OFS_X[1] = 4;
		TRASH_OKAZARI_OFS_X[2] = 8;

		TRASH_OKAZARI_OFS_Y[0] = 2;
		TRASH_OKAZARI_OFS_Y[1] = 4;
		TRASH_OKAZARI_OFS_Y[2] = 8;
	}
}